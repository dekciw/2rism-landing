				...
				function builder(e, t) {
								...
								? ((x = e),
								  ...
								  T &&
										(e.offsetTop < e.offsetParent.scrollTop ||
											e.offsetTop > e.offsetParent.scrollTop + e.offsetParent.clientHeight - e.clientHeight) &&
					...
					return (
						...
						document.querySelector('label[for="' + S.id + '"]')
							...
							: 'LABEL' === y.parentNode.tagName.toUpperCase() && (j = y.parentNode),
						void 0 !== j &&
							(j.setAttribute('id', E + '-' + L + '-label'), A.setAttribute('aria-labelledby', E + '-' + L + '-label')),
						S.disabled
							? y.classList.add(t.isDisabledClass)
							: (A.setAttribute('tabindex', '0'), S.setAttribute('tabindex', '-1'), p()),
						(y.customSelect = {
							get pluginOptions() {
								return t;
							},
				...
				function customSelect(e, t) {
					...
					return (function () {
						if (e && e instanceof HTMLElement && 'SELECT' === e.tagName.toUpperCase()) n.push(e);
							...
							for (var o = document.querySelectorAll(e), a = 0, r = o.length; a < r; ++a)
						...
						function e(e, t) {
							...
							try {
								for (
									...
									!(s = (r = i.next()).done) && (n.push(r.value), !t || n.length !== t);
									s = !0
								);
							} catch (e) {
								(o = !0), (a = e);
						...
						return (
							this.each(function () {
								...
								u
									? 'string' == typeof e &&
									  ('function' == typeof u[e]
											? ((i = u[e].apply(u, n)), 'destroy' === e && r.removeData('customSelect'))
											: n.length
											? ((u[e] = n[0]), (i = this))
											: (i = 'container' === e || 'opener' === e || 'select' === e || 'panel' === e ? t(u[e]) : u[e]))
									: (r.data('customSelect', (0, _index2.default)(this, e)[0]), (i = this));
							}),
							i
						);
					};
